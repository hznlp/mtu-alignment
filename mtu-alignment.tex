...
Problem encountered: I just change to c++11 and gcc 4.8.1, code compiled on mac, doesn't compile on hpc. 
...
BLEU
\end{enumerate}
Problem encountered: mert script offers some options to set value range for any feature. I set the value range for phrase conditional probability to [0,0]. However, the final value of that feature generated by meet is not 0.
